# @workspace/sk-editor_1 — App Desktop
...
- **Windows**: `-workspace-sk-editor-1-Setup-1.0.1.exe`
- **Mac**: `-workspace-sk-editor-1-1.0.1.dmg`
- **Linux**: `-workspace-sk-editor-1-1.0.1.AppImage`
